...
/**
 * Catalog entity for Marital Status types
 */
@Entity
...
public class CatEstadoCivil {
    ...
    public CatEstadoCivil(String codigo, String nombre) {
        this.codigo = codigo;
        this.nombre = nombre;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CatEstadoCivil)) return false;
        CatEstadoCivil that = (CatEstadoCivil) o;
